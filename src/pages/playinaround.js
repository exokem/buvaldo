...
const LoveBombBaby = ({setfilm}) => {
    ...
    const [filmState, setFilmState] = useState(1)
    const images = [
        [
  ...
  return (
    ...
    <div ref={elements[0]} className={`${(filmState === 0 ? "none": filmState === 2 ? "bg-bg2 ":"bg-bg5 bg-cover" )} h-screen w-auto`}>
        <Nav/>
        <div className='fixed top-[25%] xl:top-[40%] w-1/3 lg:w-1/4 flex items-center pl-10 z-[3] md:block hidden'>
        ...
        <div className='p-10 pt-0 hidden h-screen lg:block pb-20'>
            <div className='flex justify-center  items-center w-full'>
                <div className={`unselectable flex items-center relative z-[0]  ${animation[0]} ${filmState != 0 && "unclickable"} `} onClick={()=>handleClick(1)}>
                    <div className='z-1 flex items-center text-black'>
                    ...
                    <div className='absolute z-[-1] h-[600px] w-[900px] playin_around'/>
            ...
            }
        {
            ...
            <div ref={elements[3]} className={`h-screen w-auto hidden md:block`}>
                <div className={` w-full bg-center h-screen pt-[150px] bg-bg6  overflow-scroll flex flex-col items-end justify-center gap-10 lg:pr-20`}>
                    <div className='h-full'>
                    
                    <div className={`${filmState === 2 ? "":""} glow-box mb-10`}>
                    ...
                    <div className={`${filmState === 2 ? "":""} glow-box mb-10 mt-10`}>
                        <img src={"/Website_Photos/Campaign_Thumbnail_HQ.png"} className='w-full lg:w-[60rem]'/>
                        </div>
                        <div className='text-[20px] text-center w-[60rem] flex justify-center text-black text-[20px]'>
                            <h1>Campaign video created in order to raise funds for Playin’ Around. 
                            <br/>Directed by Muhil Vaseekaran
                        <br/>Edited by Bryan Uvaldo</h1>
                    </div>
                    <div className={`${filmState === 2 ? "":""} glow-box mb-10 mt-10`}>
                        <img src={"/Website_Photos/PlayinAround Concept Art.JPEG"} className='w-full lg:w-[60rem]'/>
                        </div>
                        <div className='text-[20px] text-center w-[60rem] flex justify-center text-black '>
                            <h1>Playin’ Around Concept Art 
                        <br/>Drawn by Caroline Ho</h1>
                    </div>
                    <div className={`${filmState === 2 ? "":""} glow-box mb-10 mt-10`}>
                        <img src={"/Website_Photos/Playin Around BTS @RSBMedia.us -246.jpeg"} className='w-full lg:w-[60rem]'/>
                        </div>
                        <div className='text-[20px] text-center w-[60rem] flex justify-center text-black'>
                            <h1>Lego Diorama for Playin’ Around
                        <br/>Designed by Bryan Uvaldo
                        <br/>Photo by Ruben Sevilla
                        </h1>
                    </div>
...
const Menu = ({film, scroll, setScroll,}) => {
  ...
  const menuItems = [["OVERVIEW", "FILM STILLS", "BEHIND THE SCENES", "Additional Materials"],["OVERVIEW", "FILM STILLS", "BEHIND THE SCENES", "TIMELINE","CREDITS"]]

  return (
    <>
    {film > 0 && 
    <div className='z-[3] flex flex-col h-1/2 justify-center gap-5 lg:gap-15 text-white'>
        {/* <div className='flex flex-col'>
