...
export default function Home() 
{
	...
	return (
		<>
			<div ref={parallax.ref} style={{filter: "blur(calc(10px * var(--progress)))"}} className={`${film !== 0 ? "hidden" : "fixed"} hidden md:flex   z-[-1]   bg-[url('/Website_Photos/ARI06304-1.jpg')] h-screen w-screen object-cover  bg-cover p-10 pt-5 flex justify-center items-end`}>
